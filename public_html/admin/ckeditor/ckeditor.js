...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (0 > e.getListenerIndex(d)) {
                    ...
                    p.fn = d;
                    p.priority = h;
                    for (var w = e.length - 1; 0 <= w; w--) if (e[w].priority <= h) return e.splice(w + 1, 0, p), {removeListener: q};
                    e.unshift(p)
                }
            ...
            once: function () {
                ...
                return function (h, p, q) {
                    ...
                    if (e) {
                        var w = e.listeners;
                        if (w.length) for (var w = w.slice(0), z, F = 0; F < w.length; F++) {
                            if (e.errorProof) try {
                                z =
                                    w[F].call(this, q, p, b, k)
                            } catch (v) {
                            } else z = w[F].call(this, q, p, b, k);
    ...
    (function () {
        ...
        var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            f = /&/g, g = />/g, k = /</g, h = /"/g, p = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            q = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, e = function (a, b) {
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                for (var h = 1; h < b; h++) {
                    var m = arguments[h], d;
                    for (d in m) if (!0 === e || null == a[d]) if (!c || d in c) a[d] = m[d]
                }
                return a
            },
            ...
            transformPlainTextToHtml: function (a, b) {
                var e = b == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    c = c.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = b == CKEDITOR.ENTER_P ? "p" : "div";
                if (!e) {
                    var m = /\n{2}/g;
                    if (m.test(c)) var d = "\x3c" + h + "\x3e", p = "\x3c/" + h + "\x3e",
            ...
            normalizeCssText: function (a, b) {
                var e = [], c, h = CKEDITOR.tools.parseCssText(a, !0, b);
            ...
            keystrokeToArray: function (a, b) {
                var e = b & 16711680, c = b & 65535, h = CKEDITOR.env.mac, m = [], d = [];
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), e, c, h = 0; h < b.length; h++) if (e = b[h].split("\x3d"), c = decodeURIComponent(CKEDITOR.tools.trim(e[0]).toLowerCase()), c === a) return decodeURIComponent(1 < e.length ? e[1] : "");
                return null
            },
            ...
            getCsrfToken: function () {
                ...
                if (!a || 40 != a.length) {
                    ...
                    if (window.crypto && window.crypto.getRandomValues) a =
                        new Uint8Array(40), window.crypto.getRandomValues(a); else for (var e = 0; 40 > e; e++) a.push(Math.floor(256 * Math.random()));
                    for (e = 0; e < a.length; e++) var c = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[e] % 36), b = b + (.5 < Math.random() ? c.toUpperCase() : c);
                    a = b;
            ...
            convertBytesToBase64: function (a) {
                var b = "", e = a.length, c;
                for (c = 0; c < e; c += 3) {
                    var h = a.slice(c, c + 3), m = h.length, d = [], p;
                    if (3 > m) for (p = m; 3 > p; p++) h[p] = 0;
                    d[0] = (h[0] & 252) >> 2;
                    d[1] = (h[0] & 3) << 4 | h[1] >> 4;
            ...
            style: {
                parse: {
                    ...
                    margin: function (a) {
                        ...
                        var e = {}, c = a.match(/(?:\-?[\.\d]+(?:%|\w*)|auto|inherit|initial|unset)/g) || ["0px"];
                        switch (c.length) {
                            case 1:
                                b([0, 0, 0, 0]);
                                break;
            ...
            object: {
                findKey: function (a, b) {
                    ...
                    var e = CKEDITOR.tools, c = e.clone(a), h = e.clone(b);
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, h = {"#": 1},
        ...
        a(d, {
            $block: a({audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1}, f, p),
            $blockLimit: {
                article: 1,
                aside: 1,
                audio: 1,
        ...
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                if (d) for (var g = -1, k = 0; k < b.childNodes.length; k++) {
                    ...
                    if (!0 !== d || 3 != h.nodeType || !h.previousSibling || 3 != h.previousSibling.nodeType) if (g++, g == f) {
                        b = h;
                        break
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++) if (e) for (var w =
                        0; w < e.length; w++) b.push([a, c[d], e[w]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                var b = 0, c = 0, e = this.getDocument(), d = e.getBody(), w = "BackCompat" == e.$.compatMode;
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var f = this.$.getBoundingClientRect(), g = e.$.documentElement,
                        v = g.clientTop || d.$.clientTop || 0, m = g.clientLeft || d.$.clientLeft || 0, k = !0;
                ...
                } else for (v = this, m = null; v && "body" != v.getName() &&
                "html" != v.getName();) {
                ...
                w = a.getWindow();
                d = v(this, w);
                var u = v(a, w), H = this.$.offsetHeight;
                e = this.$.offsetWidth;
                var n = a.$.clientHeight, r = a.$.clientWidth;
            ...
            getFrameDocument: function () {
                ...
                for (var e = 0; e < c.length; e++) {
                    var d = c[e], w = d.nodeName.toLowerCase(), f;
                    if (!(w in b)) if ("checked" == w && (f = this.getAttribute(w))) a.setAttribute(w, f); else if (!CKEDITOR.env.ie || this.hasAttribute(w)) f = this.getAttribute(w), null === f && (f = d.nodeValue), a.setAttribute(w, f)
                }
                "" !== this.$.style.cssText &&
    ...
    (function () {
        function a(a, b) {
            ...
            e = c.endContainer;
            var f = c.startOffset, x = c.endOffset, g, n = this.guard, r = this.type,
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp(), p = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, e = b.getChildCount(); c < e; ++c) if (!q(b.getChild(c))) return !!a;
                return !a
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, f) {
            ...
            function m() {
                ...
                for (a = 0; a < e; a++) if (b = O[a], c = l[a], !b.equals(c)) return a;
                return a - 1
            }

            function h() {
                var b = K - 1, c = E && y && !r.equals(C);
            ...
            a.optimizeBookmark();
            var k = 0 === b, q = 1 == b, n = 2 == b;
            b = n || q;
            var r = a.startContainer, C = a.endContainer,
                L = a.startOffset, D = a.endOffset, N, t, E, y, I, P;
            if (n && C.type == CKEDITOR.NODE_TEXT && (r.equals(C) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(C))) c.append(a.document.createText(C.substring(L, D))); else {
        ...
        var g = {
                ...
                u: 1,
                "var": 1
            }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, p = CKEDITOR.dom.walker.editable(),
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            trim: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var m = this.getCommonAncestor(), h = this.root, k, q, n, r, C, L = !1, D, N;
                        ...
                        for (n = c(n); n || r;) {
                            ...
                            for (; r;) if (D = !1, r.type == CKEDITOR.NODE_COMMENT) r = r.getPrevious(); else {
                                if (r.type == CKEDITOR.NODE_TEXT) N = r.getText(), d.test(N) && (r = null), D = /[\s\ufeff]$/.test(N); else if ((r.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && r.is("br")) && !r.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                                    N =
                                        r.getText();
                                    if (d.test(N)) r = null; else for (var t = r.$.getElementsByTagName("*"), E = 0, y; y = t[E++];) if (!CKEDITOR.dtd.$removeEmpty[y.nodeName.toLowerCase()]) {
                                        r = null;
                                        break
                                    }
                                    r && (D = !!N.length)
                        ...
                        for (; n || r;) {
                            ...
                            for (; r;) {
                                D = !1;
                                if (r.type == CKEDITOR.NODE_TEXT) N = r.getText(), g(r, 0) || (r = null), D = /^[\s\ufeff]/.test(N); else if (r.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < r.$.offsetWidth || b && r.is("br")) && !r.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
                                        N =
                                            r.getText();
                                        if (d.test(N)) r = null; else for (t = r.$.getElementsByTagName("*"), E = 0; y = t[E++];) if (!CKEDITOR.dtd.$removeEmpty[y.nodeName.toLowerCase()]) {
                                            r = null;
                                            break
                                        }
                                        r && (D = !!N.length)
                ...
                if (!this.collapsed) {
                    ...
                    var g = new CKEDITOR.dom.walker(g), r = CKEDITOR.dom.walker.bookmark(),
            ...
            fixBlock: function (a, b) {
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, g = d.block, m = null;
                ...
                return {previousBlock: f, nextBlock: g, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: m}
                ...
                var c, d = 0, f, g, m = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
            ...
            moveToElementEditEnd: function (a) {
                ...
                function a(b, c) {
                    var d = CKEDITOR.tools.array.map(b, function (a) {
                        return a
                    }), e = new CKEDITOR.dom.range(c.root), f, g, n;
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), f = [], g, m, h, k;
                if (c && c.find) for (m = c.find(a), g = 0; g < m.count(); g++) if (c = m.getItem(g), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = v.startPath();
                    var m = v.endPath(), M = !v.collapsed && c(v, k.block), u = !v.collapsed && c(v, m.block, 1);
                ...
                for (this._.nextNode = null; m;) {
                    var M = 0, u = m.hasAscendant("pre"), H = m.type != CKEDITOR.NODE_ELEMENT, n = 0;
                    if (H) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (H = 0); else {
                        var r = m.getName();
                        if (CKEDITOR.dtd.$block[r] && "false" == m.getAttribute("contenteditable")) {
                            ...
                            if ("br" == r) H = 1; else if (!k && !m.getChildCount() && "hr" != r) {
                                d = m;
                                w = m.equals(v);
                                break
                            }
                    ...
                    w = (!M || H) && m.equals(v);
                    if (k && !M) for (; !m.getNext(h) && !w;) {
                        r = m.getParent();
                        if (r.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            M = 1;
                            H = 0;
                            w || r.equals(v);
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                n = b[f];
                n = "boolean" == typeof n ? {} : "function" == typeof n ? {match: n} : E(n);
                ...
                for (g in P) {
                    l[g] = k(l[g], m) || null;
                    var r = l, t = O[g], y = k(l[O[g]], m), B = l[g], h = [], A = !0, C = void 0;
                    y ? A = !1 : y = {};
        ...
        function z(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var g = 0, t = n.length, E; g < t; ++g) if (E = n[g](b)) {
                        n = E;
                        break a
                    }
                    n = void 0
            ...
            if (f.doFilter) {
                a:{
                    ...
                    if (a || n) {
                        w(b);
                        if (g) for (k = 0, C = g.length; k < C; ++k) if (!1 === c(g[k], b, y)) {
                            a = null;
                            break a
                        }
                        if (t) for (k = 0, C = t.length; k < C; ++k) c(t[k], b, y);
                        if (a) for (k = 0, C = a.length; k < C; ++k) d(a[k], b, y, E);
                        if (n) for (k = 0, C = n.length; k < C; ++k) d(n[k], b, y, E);
                        a = y
                    } else a = null
                }
                ...
                var h = a.validStyles;
                n = a.validClasses;
                var g = b.attributes, I = b.styles, t = b.classes;
                E = b.classBackup;
                var L = b.styleBackup, K, D, O = [], y = [], J = /^data-cke-/;
                k = !1;
                delete g.style;
                delete g["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (K in g) C[K] || (J.test(K) ? K == (D = K.replace(/^data-cke-saved-/, "")) || C[D] || (delete g[K], k = !0) : (delete g[K], k = !0));
        ...
        function n(a, b, c) {
            ...
            if (t.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (t.$block[d] || "tr" == d) if ("br" == b) a.previous && !H(a.previous) && (b = u(), b.insertBefore(a)), a.next && !H(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = t[b];
                    for (var f = 0, n = d.length, l; f < n; ++f) if (l = d[f], l.type == CKEDITOR.NODE_ELEMENT && !e[l.name]) {
                        e = !1;
                        break b
                    }
                    e = !0
        ...
        function C(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, f, n, l, g;
            if (a.name != c.element) return !1;
            for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), l = a.classes.join("|"); g = c.pop();) {
                if (-1 == l.indexOf(g)) return !1
            } else if (a.attributes[f] != d[f]) return !1;
            for (n in e) if (a.styles[n] !=
                e[n]) return !1;
            return !0
        }
        ...
        var t = CKEDITOR.dtd, E = CKEDITOR.tools.copy, y = CKEDITOR.tools.trim, I = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], l = this.editor && this.editor.config.protectedSource, g, r = !1,
                    E = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (g = z(e, a, f, E), g & 1) r = !0; else if (g & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var n, G, m;
                            if (l) for (G = 0; G < l.length; ++G) if ((m = d.match(l[G])) && m[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (n = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, n, c, E);
                            c = !c.length
                        }
                        c || f.push(a)
                    }
                ...
                for (; y = a.pop();) if (c = y.el, c.parent) switch (k = t[c.parent.name] || t.span, y.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var f = void 0, n = void 0, l = void 0, g = void 0, m = void 0, t = void 0;
                        c = [];
                ...
                var l = CKEDITOR.tools.clone(f), g = [], m;
                if (!1 !== b && (m = this._.transformations[f.name])) {
                    for (d =
                             0; d < m.length; ++d) r(this, f, m[d]);
                    v(f)
                }
                z(this, l, g, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var P = {styles: 1, attributes: 1, classes: 1},
            ...
            K = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, B = /^cke:(object|embed|param)$/,
            A = /^(object|embed|param)$/, J;
        J = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, f = c.attributes, e, l, n, g;
                    a.name = c.element;
                    for (e in f) if ("class" == e) for (c =
                                                            a.classes.join("|"), n = f[e].split(/\s+/); g = n.pop();) -1 == c.indexOf(g) && a.classes.push(g); else a.attributes[e] = f[e];
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, f, g) {
                ...
                k && (b = [b]);
                f || (f = CKEDITOR);
                var h = b.length, p = [], q = [], e = function (a) {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            for (var c = this.loaded, f = this.registered, g = [], k = {}, h = {}, p = 0; p < a.length; p++) {
                var q = a[p];
                if (q) if (c[q] || f[q]) h[q] = this.get(q); else {
            ...
            CKEDITOR.scriptLoader.load(g, function (a, e) {
                ...
                for (var f = 0; f < a.length; f++) for (var g = k[a[f]], p = 0; p < g.length; p++) {
                    var m = g[p];
                    h[m] = this.get(m);
                    c[m] = 1
                }
        ...
        return function (b, c, f) {
            var g = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], e;
                    for (e in a) {
                        var h = a[e], w = h && h.requires;
                        if (!d[e]) {
                            if (h.icons) for (var z = h.icons.split(","), F = z.length; F--;) CKEDITOR.skin.addIcon(z[F], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[F] + ".png");
                            d[e] = 1
                        }
                        if (w) for (w.split && (w = w.split(",")), h = 0; h < w.length; h++) g[w[h]] || b.push(w[h])
                    }
    ...
    (function () {
        ...
        function x(a) {
            ...
            if (e) var g = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g, ""),
                d = d + ("," + e);
            if (f) var k = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(k, "");
            ...
            CKEDITOR.plugins.load(d.split(","),
                function (b) {
                    ...
                    for (var n in b) {
                        var g = b[n], r = g.lang, h = null, l = g.requires, C;
                        CKEDITOR.tools.isArray(l) && (l = l.join(","));
                        if (l && (C = l.match(k))) for (; l = C.pop();) CKEDITOR.error("editor-plugin-required", {
                            plugin: l.replace(",", ""),
                            requiredBy: n
                        });
                    ...
                    CKEDITOR.scriptLoader.load(f, function () {
                        for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++) for (var l = 0; l < d.length; l++) {
                            var n = d[l];
        ...
        function z(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, g, k, h = 0; h < a.length; h++) {
                var N = a[h], t = N.startContainer.getAscendant("tr", !0);
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            plugins: {
                ...
                if (c) {
                    var f =
                        CKEDITOR.tools.object.findKey(this.commands, c), e = this.keystrokeHandler.keystrokes;
                    if (c.fakeKeystroke) d.push(c.fakeKeystroke); else for (var g in e) e[g] === f && d.push(g)
                }
                return b ? d : d[0] || null
            }, addFeature: function (a) {
            ...
            function (g, k, h) {
                function p(a) {
                    ...
                    if (0 < m.length) for (var c = 0; c < m.length; c++) {
                        var d = m[c], f = d.name, e = CKEDITOR.dtd[f], n = u.name && CKEDITOR.dtd[u.name];
                ...
                var F = new CKEDITOR.htmlParser,
                    ...
                    m = [], M = [], u = v, H = "textarea" == v.name, n = "pre" == v.name;
                    ...
                    if (a(e)) m.push(e); else {
                        ...
                        if ("br" == f) M.push(e); else {
                            for (; !(k = (g = u.name) ? CKEDITOR.dtd[g] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || u.isUnknown || k[f]);) if (u.isOptionalClose) F.onTagClose(g); else if (f in b && g in b) g = u.children, (g = g[g.length - 1]) && "li" == g.name || x(g = new CKEDITOR.htmlParser.element("li"), u), !e.returnPoint && (e.returnPoint = u), u = g; else if (f in CKEDITOR.dtd.$listItem &&
                                !z(f, g)) F.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (g in d && !z(f, g)) !e.returnPoint && (e.returnPoint = u), u = u.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(u), u.parent) x(u, u.parent, 1); else {
                                e.isOrphan = 1;
                                break
                            }
                            p(f);
                ...
                F.onText = function (a) {
                    ...
                    if (!H && !e["#"] && b in d) F.onTagOpen(f[b] || ""), F.onText(a); else {
                        q();
                        p();
                        n || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    g = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, p, q, e, x;
                for (x = 0; x < h; x++) if (d && (p = c.type, q = c.name), e = k[x], !(a.nonEditable && !e.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function l(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var l = [], n = b(f), E, G;
                        if (n) for (t(n, 1) && l.push(n); n;) g(n) && (E = c(n)) && t(E) && ((G = c(E)) && !g(G) ? l.push(E) : (e(y).insertAfter(E), E.remove())), n = n.previous;
            ...
            var E = {elements: {}}, y = "html" == d, B = CKEDITOR.tools.extend({}, C), h;
        ...
        function z(a) {
            return CKEDITOR.tools.array.reduce(a.split(""), function (a, b) {
                var c = b.toLowerCase(), d = b.toUpperCase(), e = F(c);
                c !== d && (e += "|" + F(d));
                return a + ("(" + e + ")")
            }, "")
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            c.addRules(a(b, "data"),
                {applyToAll: !0});
            f.addRules(N);
            f.addRules(t, {applyToAll: !0});
            f.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                    a = a.data;
                    var c = a.dataValue, f, c = c.replace(K, ""), c = M(c, b), c = e(c, O), c = q(c), c = e(c, P),
                        c = c.replace(B, "$1cke:$2"), c = c.replace(J, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                        c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
        ...
        var u = /(?:&nbsp;|\xa0)$/, H = "{cke_protected}", n = CKEDITOR.dtd,
            r = "caption colgroup col thead tfoot tbody".split(" "),
            C = CKEDITOR.tools.extend({}, n.$blockLimit, n.$block), L = {elements: {input: h, textarea: h}}, D = {
        ...
        var E = /<(a|area|img|input|source)\b([^>]*)>/gi,
            y = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, I = /^(href|src|name)$/i,
            P = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            O = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, l = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            ...
            A = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, J = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var p, q;
                for (p in k) {
                    for (h = k[p]; ;) if (q = a.onAttributeName(b, p)) if (q != p) delete k[p], p = q; else break; else {
                        delete k[p];
                        break
                    }
                ...
                b && this.filter(b);
                var g = this.name, k = [], h = this.attributes, p, q;
                a.openTag(g, h);
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, g = c.count(); f < g; f++) a = c.getItem(f), "true" == a.getAttribute("contenteditable") && (d = {
                element: a,
                config: {}
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var h = d.checkDirty(), k = d._.previousModeData, p, q = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = p = d.getData(1);
                    "source" == d.mode && k == p && (d.fire("lockSnapshot", {forceUpdate: !0}), q = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var h = this.container, p = this.ui.space("contents"),
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, h = g.getRanges()[0], t;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = d(g, e)) g.appendBogus(), t = CKEDITOR.env.ie;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var t, g;
                    if (f) for (; (t = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[t.getName()]) && (!g || !g[e]);) t.getName() in CKEDITOR.dtd.span ? b.splitElement(t) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(t), b.collapse(!0), t.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ?
                        "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                    ...
                    var c = H, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                            a:{
                                var d = c.block.getElementsByTag("span"), f = 0, t;
                                if (d) for (; t = d.getItem(f++);) if (!x(t)) {
                                    d = !0;
                                    break a
                                }
                                d = !1
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var h = f.getHead(), m = h.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in
                                    t) {
                                    var f, k = b.getRanges()[0], l = k.startPath(), h, B, A, c = 8 == c;
        ...
        v = function () {
            ...
            function b(c, d) {
                var e, f, g, t, k = [], y = d.range.startContainer;
                e = d.range.startPath();
                for (var y = E[y.getName()], h = 0, I = c.getChildren(), m = I.count(), q = -1, p = -1, P = 0, D = e.contains(E.$list); h < m; ++h) e = I.getItem(h), a(e) ? (g =
                    ...
                    name: g,
                    allowed: t
                }), f = P = 0)) : k.push({isElement: 0, node: e, allowed: 1});
                -1 < q && (k[q].firstNotAllowed = 1);
                -1 < p && (k[p].lastNotAllowed = 1);
                return k
            }

            function d(b, c) {
                var e = [], f = b.getChildren(), g = f.count(),
                    t, k = 0, y = E[c], h = !b.is(E.$inline) || b.is("br");
            ...
            return function (y, l, K, B) {
                ...
                if (!B.checkReadOnly()) {
                    ...
                    if (!l.collapsed) {
                        var A = G.block || G.blockLimit, w = l.getCommonAncestor();
                        A && !A.equals(w) && !A.contains(w) && l.checkEndOfBlock() && y.zombies.push(A);
                        l.deleteContents()
                    }
                    for (; (p = e(l)) && a(p) && p.isBlockBoundary() && J.contains(p);) l.moveToPosition(p, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    for (A = q.startNode; (A = A.getParent()) && f(A);) B.push(A);
                    l.moveToBookmark(q);
                    if (q = K) {
                        q = y.range;
                        ...
                        if ((v = q.startPath().block) && (1 !=
                            ...
                            if (1 == p.getChildCount() && a(x = p.getFirst()) && x.is(I) && !x.hasAttribute("contenteditable")) {
                                ...
                                q = 0;
                                for (B = v.count(); q < B; q++) if (l = v.getItem(q), !l.is(m)) break a;
                    ...
                    if (q) {
                        ...
                        var H, M;
                        l = x.startContainer;
                        var J = y.endPath.elements[0], W, G = J.getPosition(l),
                        ...
                        for (t(l, x); B < l.length; B++) {
                            ...
                            if (u) K = 0 < B; else {
                                ...
                                if (A && G.isElement) {
                                    ...
                                    if (u) H && (M = x.splitElement(H), y.zombies.push(M), y.zombies.push(H)); else {
                                        H = p.getName();
                                        W = !B;
                                        u = B == l.length - 1;
                                        H = d(G.node, H);
                                        for (var S =
                                            [], Y = H.length, Z = 0, ba = void 0, ca = 0, U = -1; Z < Y; Z++) ba = H[Z], " " == ba ? (ca || W && !Z || (S.push(new CKEDITOR.dom.text(" ")), U = S.length), ca = 1) : (S.push(ba), ca = 0);
                                        u && U == S.length && S.pop();
                                        W = S
                                    }
                                }
                    ...
                    if (M) for (; F = M.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() : F.append(z.document.createText(" "));
        ...
        m = function () {
            ...
            return function (d) {
                var e = d.startContainer, f = e.getAscendant("table", 1), t = !1;
            ...
            eol: {
                ...
                rebuild: function (a, b) {
                    var c = a.range, d = c.getCommonAncestor(), e = new CKEDITOR.dom.elementPath(d, b),
                        ...
                        c = new CKEDITOR.dom.elementPath(c.endContainer, b), t;
                        ...
                        g.guard = function (a, g) {
                            ...
                            if (g && k && a.equals(k)) f = c.clone(), f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && h && a.equals(h)) f = c.clone(), f.setStartAt(h, CKEDITOR.POSITION_AFTER_START), e.push(f); else {
                                if (A = !g) A = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h ||
                                    b(a, h));
                                if (!A && (A = g)) if (a.is(d)) var A = k && k.getAscendant("table", !0),
                                    I = h && h.getAscendant("table", !0), m = a.getAscendant("table", !0),
                                    A = A && A.contains(m) || I && I.contains(m); else A = void 0;
    ...
    (function () {
        ...
        function q(a) {
            ...
            var c = a.startContainer, d = a.getPreviousNode(p,
                null, c), e = a.getNextNode(p, null, c);
        ...
        function v(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    ...
                    d = c.startContainer;
                    e = c.endContainer;
                    var f = c.startOffset, l = c.endOffset, g = c.clone();
        ...
        var m = "function" != typeof window.getSelection, M = 1, u = CKEDITOR.tools.repeat("​", 7),
            H = new RegExp(u + "( )?", "g"), n, r, C, L = CKEDITOR.dom.walker.invisible(1), D = function () {
                function a(b) {
                    return function (a) {
                        var c =
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var e = c.document, f = CKEDITOR.document, h = c.editable(), t = e.getBody(),
                    n = e.getDocumentElement(), E = h.isInline(), q, p;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                var a = m ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                                 m = e.length - 1, n = -1, t, q; k <= m;) if (n = Math.floor((k + m) / 2), f = e[n], h.moveToElementText(f), t = h.compareEndPoints("StartToStart", b), 0 < t) m = n - 1; else if (0 > t) k = n + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        ...
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h) return {container: d, offset: a(f) + (0 < t ? 0 : 1)};
                        for (; 0 < h;) try {
                        ...
                        return {container: q, offset: 0 < t ? -h : q.nodeValue.length + h}
                    };
                    return function () {
                ...
                this.reset();
                if (c) for (var c = this.root, g, h = 0; h < a.length; ++h) g =
                        ...
                        if (m) {
                            ...
                            for (G = 0; G < a.length; G++) {
                                ...
                                try {
                                    ...
                                    if (0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), J.setEnd(b.endContainer.$, b.endOffset); else throw r;
                                }
                                k.addRange(J)
                            }
                        }
    ...
    (function () {
        ...
        function b(c) {
            var e = c.document;
            if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, m = h.ignoreReadonly, n = m || h.includeReadonly;
                null ==
                ...
                c.trim();
                var p = c.createBookmark(), t = p.startNode, w = p.endNode, r = t, x;
                if (!m) {
                    var u = c.getCommonAncestor(), m = a(t, u), u = a(w, u);
                    m && (r = m.getNextSourceNode(!0));
                    u && (w = u)
                }
                for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    m = !1;
                    if (r.equals(w)) r = null, m = !0; else {
                        ...
                        if (u && n && CKEDITOR.dtd.$block[v]) for (var C = r, D = f(C), E = void 0, H = D.length, I = 0, C = H && new CKEDITOR.dom.range(C.getDocument()); I < H; ++I) {
                            var E = D[I], L = CKEDITOR.filter.instances[E.data("cke-filter")];
                            if (L ? L.check(this) : 1) C.selectNodeContents(E), b.call(this, C)
                        }
                        D = v ? !q[v] || z ? 0 : u && !n ? 0 : d(r, w, h, P) : 1;
                        if (D) if (E = r.getParent(), D = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || D.parentRule &&
                        !D.parentRule(E)) m = !0; else {
                            if (x || v && CKEDITOR.dtd.$removeEmpty[v] && (r.getPosition(w) | P) != P || (x = c.clone(), x.setStartBefore(r)), v = r.type, v == CKEDITOR.NODE_TEXT || u || v == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var v = r, N; (m = !v.getNext(y)) && (N = v.getParent(), q[N.getName()]) && d(N, t, h, O);) v = N;
                                x.setEndAfter(v)
                            }
                        } else m = !0;
        ...
        function z(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = n(this)[a.getName()],
                f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
            for (g in d) if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == r(g, d[g])) b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g));
        ...
        var D = {
                ...
                audio: 1,
                video: 1
            }, t = /\s*(?:;\s*|$)/, E = /#\((.+?)\)/g, y = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (a) {
            ...
            var g = this.elements, k = g.length;
            d && (b ? c += 1 : --k);
            b && (g = Array.prototype.slice.call(g, 0), g.reverse());
            for (; c < k; c++) if (f(g[c])) return g[c];
            return null
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, k = c[d ? "endContainer" : "startContainer"], h = d ? "endOffset" : "startOffset",
                        ...
                        if (h && 1 < a.length) {
                            ...
                            if (k) for (var q = 0; a[g + q + 1];) {
                                ...
                                for (e = e.getById(d[q + 1].startNode); ;) {
                                    ...
                                    if (e.equals(p)) k = 1; else if (c(p) || p.type == CKEDITOR.NODE_ELEMENT && p.isBlockBoundary()) continue;
                                    break
                                }
                                if (!k) break;
                                q++
            ...
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                ...
                a = function (a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        ...
                        h.push(a);
                        var d = b.getUiColor();
                        d && f([a], CKEDITOR.skin.chameleon(b, "panel"), [[p, d]])
                    }
                };
                b.on("panelShow", a);
                b.on("menuShow", a);
...
*/
    ...
    (function () {
        ...
        function E(a) {
            ...
            a.on("contentDom", function () {
                ...
                function d(c, d) {
                    c.select();
                    r(a, {dataTransfer: d, method: "drop"}, 1);
                ...
                e.attachListener(f, "drop", function (c) {
                    if (!c.data.$.defaultPrevented) {
                        ...
                        if (!d.isReadOnly() || d.type == CKEDITOR.NODE_ELEMENT && d.is("html")) {
                            var d = b.getRangeAtDropPosition(c, a), e = b.dragRange;
                            d && g(c, e, d)
                        }
                    }
                }, null, null, 9999);
    ...
    (function () {
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c, b) {
                ...
                if (!g.type) if (f = a.match(x)) g.type = "anchor", g.anchor = {}, g.anchor.name = g.anchor.id = f[1]; else if (f = a.match(E)) g.type = "tel", g.tel = f[1]; else if (f = a.match(u)) {
                    e = a.match(v);
                    a = a.match(w);
                    g.type = "email";
                    var k = g.email = {};
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function (c) {
                ...
                if (b && (d = b.getSelectedElement()) && (d.getChildCount() ? d.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, d))) d.remove(1); else if (d = CKEDITOR.plugins.link.getSelectedLink(c)) d.hasAttribute("href") ? (d.removeAttributes({
                    name: 1,
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                renderHtml: function (a) {
                    ...
                    var c = CKEDITOR.env, h = "cke_" + this.id, e = CKEDITOR.tools.addFunction(function (b) {
    ...
    (function () {
        function b(a, b, d, c, h, q, r, v) {
            for (var w = a.config, t = new CKEDITOR.computedStyle(r), x = [], l = {}, m = 0; m < h.length; m++) {
                var n = h[m];
                if (n) {
                    var n = n.split("/"), u = {}, p = h[m] = n[0];
                    u[d] = x[m] = n[1] || p;
                    l[p] = new CKEDITOR.computedStyle(r, u);
            ...
            a.ui.addRichCombo(b, {
                ...
                init: function () {
                    var b;
                    b = "(" + a.lang.common.optionDefault + ")";
                    this.startGroup(c.panelTitle);
                    this.add(this.defaultValue, b, b);
                    for (var g = 0; g < h.length; g++) b = h[g], this.add(b, l[b].buildPreview(), b)
                },
                onClick: function (f) {
                    var g = l[f], h = this.getValue(), k = h && f != h ? l[h] : void 0, d = f == this.defaultValue;
                    if (g && "Font" == b && a.config.font_blockWhileLoadingFont) {
                        var c = "12pt " + g._.definition.name;
                        if (document.fonts.check(c)) this.applyStyle(g, k, d); else {
                            var y = this;
                            a.fire("fontLoading", {font: g._.definition.name});
                            CKEDITOR.tools.setTimeout(function () {
                                a.setReadOnly(!0);
                                document.fonts.load(c).then(function () {
                                    a.setReadOnly(!1);
                                    y.applyStyle(g, k, d);
                                    a.fire("fontLoaded", {font: g._.definition.name})
                                }, function () {
                                    a.setReadOnly(!1);
                                    a.fire("fontLoadingFailed", {font: g._.definition.name})
                                })["finally"](function () {
                                    a.fire("fontLoadingComplete", {font: g._.definition.name})
                                })
                            }, 0)
                        }
                ...
                applyStyle: function (b, g, h) {
                    ...
                    a.fire("saveSnapshot");
                    var k, d, c, e, l;
                    if (g) if (k = a.getSelection().getRanges()[0], k.collapsed) {
                        if (d = a.elementPath(), c = d.contains(function (a) {
                            return g.checkElementRemovable(a)
                        })) {
                            e =
                                k.checkBoundaryOfElement(c, CKEDITOR.START);
                            l = k.checkBoundaryOfElement(c, CKEDITOR.END);
                            if (e && l) {
                                for (e = k.createBookmark(); d = c.getFirst();) d.insertBefore(c);
                                c.remove();
                                k.moveToBookmark(e)
                            } else e || l ? k.moveToPosition(c, e ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_END) : (k.splitElement(c), k.moveToPosition(c, CKEDITOR.POSITION_AFTER_END)), f(k, d.elements.slice(), c);
                            a.getSelection().selectRanges([k])
                        }
                    } else a.removeStyle(g);
                    h ? g && a.removeStyle(g) : a.applyStyle(b);
                    a.fire("saveSnapshot")
                },
                onRender: function () {
                    a.on("selectionChange",
                        function (b) {
                            ...
                            if (0 < b.length) {
                                b = b[0];
                                var d = getComputedStyle(b.$), e;
                                for (e in l) if (l[e].checkStyleMatch(b, d, !0, a)) {
                                    e != c && this.setValue(e);
                                    return
                                }
                                if (e = r.getStyleValue(d)) {
                                    this.setValue("", e);
                                    return
                                }
                            }
                ...
                refresh: function () {
                    a.activeFilter.check(t) || this.setState(CKEDITOR.TRISTATE_DISABLED)
                }
            })
        }
        ...
        function f(a, b, d) {
            var c = b.pop();
            if (c) {
                if (d) return f(a, b, c.equals(d) ? null : d);
                d = c.clone();
                a.insertNode(d);
        ...
        CKEDITOR.plugins.add("computedfont", {
            requires: "richcombo", init: function (a) {
                var e = a.config, d = e.font_names.split(";"), c = e.fontSize_sizes.split(";").map(function (a) {
                    return [a, "/", a].join("")
                });
                b(a, "Font", "family", a.lang.computedfont, d, e.font_defaultLabel, e.font_style, 30);
                b(a, "FontSize", "size", a.lang.computedfont.fontSize, c, e.fontSize_defaultLabel, e.fontSize_style, 40)
            }
        })
    })();
    CKEDITOR.config.font_names = "Arial/Arial, Helvetica, sans-serif;Comic Sans MS/Comic Sans MS, cursive;Courier New/Courier New, Courier, monospace;Georgia/Georgia, serif;Lucida Sans Unicode/Lucida Sans Unicode, Lucida Grande, sans-serif;Tahoma/Tahoma, Geneva, sans-serif;Times New Roman/Times New Roman, Times, serif;Trebuchet MS/Trebuchet MS, Helvetica, sans-serif;Verdana/Verdana, Geneva, sans-serif";
    CKEDITOR.config.font_defaultLabel = "";
    CKEDITOR.config.font_blockWhileLoadingFont = !1;
    CKEDITOR.config.font_detect = !0;
    CKEDITOR.config.font_detect_pangram = "Nymphsblitzquickvexdwarfjog012345!@#$%^\x26* 키스의고유조건은입술끼리만나야하고いろはにほへとちりぬるを わかよたれそ視野無限廣窗外有藍天微風迎客軟語伴茶";
    ...
    CKEDITOR.config.font_style = {
        ...
        getStyleValue: function (b) {
            var f = b.fontFamily.split(",");
            return 1 < f.length ? CKEDITOR.config.font_detect ? this.detectFont(f) : f[0] : b.fontFamily.replace(/['"]/g, "")
        },
        detectFont: function (b) {
            if (Array.isArray(b) && 0 != b.length) {
                var f = document.createElement("canvas").getContext("2d"), a = CKEDITOR.config.font_detect_pangram,
                    e = CKEDITOR.config.font_detect_size, d = CKEDITOR.config.font_detect_fallback;
                for (i in b) {
                    var c = b[i], h = c, h = h.trim().replace('"', "").replace("'", "");
                    f.font = [e, "px ", d].join("");
                    var q = f.measureText(a).width;
                    f.font = [e, 'px "', h, '", ', d].join("");
    ...
    CKEDITOR.config.fontSize_style = {
        ...
        getStyleValue: function (b) {
            return CKEDITOR.tools.convertToPx(b.fontSize)
        }
    };
    CKEDITOR.computedStyle = CKEDITOR.tools.createClass({
        base: CKEDITOR.style, $: function (b, f) {
            this.base(b, f)
        }, proto: {
            checkStyleMatch: function (b, f, a, e) {
                if (this.checkElementMatch(b, a, e)) return !0;
                b = this._.definition;
                return b.name == b.getStyleValue(f)
            }
        }
    });
    CKEDITOR.style.addCustomHandler({
        type: "computed", setup: function (a) {
            this.definition = a;
            var d = Object.assign({}, a);
            delete d.type;
            this.style = new CKEDITOR.style(d);
            a.negation && (this.negatedStyle = new CKEDITOR.style(a.negation));
            ...
            this.negatedStyle && this.negatedStyle.remove(a);
            this.style.apply(a)
        }, remove: function (a) {
            this.style.checkActive(a.elementPath(),
                a) ? this.style.remove(a) : this.negatedStyle && this.negatedStyle.apply(a)
        }, checkActive: function (a, d) {
            if (this.style.checkActive(a, d)) return !0;
            if (!a || !a.lastElement) return !1;
            var b = window.getComputedStyle(a.lastElement.$);
            return this.definition.checkActive(b)
    ...
    CKEDITOR.plugins.add("computedstyles", {
        init: function (a) {
            var d = 0, b = function (b, f, c, e) {
                e && (e.type = "computed", e = new CKEDITOR.style(e), a.attachStyleStateChange(e, function (b) {
                    !a.readOnly && a.getCommand(c).setState(b)
                }), a.addCommand(c, new CKEDITOR.styleCommand(e)), a.ui.addButton && a.ui.addButton(b, {
                    label: f,
                    command: c,
                    toolbar: "basicstyles," + (d += 10)
                }))
            }, f = a.config, c = a.lang.computedstyles;
            b("Bold", c.bold, "bold", f.computedStyles_bold);
            b("Italic", c.italic, "italic", f.computedStyles_italic);
            b("Underline", c.underline,
                "underline", f.computedStyles_underline);
            b("Strike", c.strike, "strike", f.computedStyles_strike);
    ...
    CKEDITOR.config.computedStyles_bold = {
        element: "strong",
        overrides: "b",
        negation: {element: "span", attributes: {style: "font-weight: normal"}},
        checkActive: function (a) {
            return (a = a["font-weight"]) && 400 < a
        }
    };
    CKEDITOR.config.computedStyles_italic = {
        element: "em",
        overrides: "i",
        negation: {element: "span", attributes: {style: "font-style: normal"}},
        checkActive: function (a) {
            a = a["font-style"];
            return "italic" == a || "oblique" == a
        }
    };
    CKEDITOR.config.computedStyles_underline = {
        element: "u", overrides: "ins", checkActive: function (a) {
            return (a = a["text-decoration"]) && -1 != a.indexOf("underline")
        }
    };
    CKEDITOR.config.computedStyles_strike = {
        element: "s", overrides: ["strike", "del"], checkActive: function (a) {
            return (a = a["text-decoration"]) && -1 != a.indexOf("line-through")
        }
    };
    ...
    CKEDITOR.plugins.add("colorbutton", {
        requires: "panelbutton,floatpanel", init: function (e) {
            ...
            if (!CKEDITOR.env.hc) {
                ...
                var w = {}, x = e.config.colorButton_normalizeBackground;
    ...
    CKEDITOR.config.plugins = 'basicstyles,dialogui,dialog,notification,button,toolbar,clipboard,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,colordialog,panel,floatpanel,listblock,richcombo,computedfont,computedstyles,menu,contextmenu,liststyle,blockquote,image,justify,lineutils,panelbutton,colorbutton';
